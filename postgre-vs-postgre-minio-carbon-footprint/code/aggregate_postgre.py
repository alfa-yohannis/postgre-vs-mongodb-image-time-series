...
def main() -> None:
    ...
    run_csv_path = settings.result_csv("results_postgres_aggregate_runs")
    summary_csv_path = settings.result_csv("results_postgres_aggregate_summary")
    ...
    try:
        with conn.cursor() as cur:
            print("PostgreSQL aggregation benchmark")
