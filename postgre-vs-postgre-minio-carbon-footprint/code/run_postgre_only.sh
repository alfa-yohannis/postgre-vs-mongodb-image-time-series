...
for PROFILE in "${PROFILES[@]}"; do
    ...
    rm -f "results_postgres_retrieve_runs_${PROFILE}.csv"
    rm -f "results_postgres_retrieve_summary_${PROFILE}.csv"
    ...
    rm -f "$RESULTS_DIR/results_postgres_retrieve_runs_${PROFILE}.csv"
    rm -f "$RESULTS_DIR/results_postgres_retrieve_summary_${PROFILE}.csv"
...
for PROFILE in "${PROFILES[@]}"; do
    ...
    run_step "[$PROFILE] PG Retrieval benchmark..." "\"$PYTHON_BIN\" retrieve_postgre.py"
