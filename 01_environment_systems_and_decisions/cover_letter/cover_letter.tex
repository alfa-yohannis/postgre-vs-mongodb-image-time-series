...
%% Before sending: fill the editor's name (line ~27), confirm the exact ATIGB conference
%% title/edition/dates (% TODO below), and attach the two conference papers as Related Files.
...
In the interest of transparency, this manuscript consolidates and substantially extends two of
our earlier conference papers, each of which separately compared only two of the three
approaches. Those two papers have been \emph{accepted for presentation} at the ATIGB conference
(\url{https://atigb.ute.udn.vn/}; University of Technology and Education~--~The University of
Danang, Vietnam) % TODO: confirm the exact full conference title, edition/year, and dates
and are awaiting presentation; we provide them as related/supporting files for your reference.
The present work goes well beyond them: it measures the energy directly (rather than estimating
it from an assumed, fixed power draw), brings all three approaches together under one common
test, extends the range to the largest image size (where the document-database limit appears),
and adds the carbon-aware decision guide and the environmental analyses that are its central
contribution.

This journal manuscript is original and is not under consideration elsewhere; aside from the two
conference papers disclosed above, which it extends, its results have not been published. All
authors have read and approved it and declare no competing interests. To support
reproducibility, the benchmark code, configuration, and raw measurements will be released in a
public repository with a permanent identifier upon acceptance; for double-anonymous review, an
anonymized copy (containing no author-identifying information) is available at
\href{https://zenodo.org/records/20625061?preview=1&token=eyJhbGciOiJIUzUxMiJ9.eyJpZCI6IjE1ZDQyNzc4LTYxYTYtNDA0ZS1iMWIxLTVjOWQ1NGJmMjE2OSIsImRhdGEiOnt9LCJyYW5kb20iOiIxNDVkNjFjY2YyYzQ0MWJkYjlhOTFiODVhZWIzYjBjNCJ9.vP1B47u0fgzHZBwAfzy0vaCovVocEnyunccYdxbtm93wzaFI53PeTa-6z-Z7x9CQ43_AjJXBcsz4xJx1lfP3DQ}{this
anonymized Zenodo record}. Thank you for considering our
submission.
