...
% ===== Author and affiliation details HIDDEN FOR DOUBLE-BLIND REVIEW =====
% Restore the original block below for the camera-ready (non-anonymous) version:
...
% ===== Original acknowledgments HIDDEN FOR DOUBLE-BLIND REVIEW =====
% Restore for camera-ready; the AI-use disclosure should also be entered via the
% submission system's Acknowledgements field (ESD asks for it outside the manuscript):
...
\begin{itemize}
% \item \textbf{Funding:} Partial institutional support from Universitas Pradita and Universitas Multimedia Nusantara. % (original; restore for camera-ready)
\item \textbf{Funding:} [Hidden for Double-blind Review].
