...
def main() -> None:
    ...
    run_csv_path = settings.result_csv("results_postgres_point_read_runs")
    summary_csv_path = settings.result_csv("results_postgres_point_read_summary")
    ...
    try:
        with conn.cursor() as cur:
            print("PostgreSQL point-read benchmark")
