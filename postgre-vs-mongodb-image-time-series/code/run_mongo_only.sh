...
echo "WITH ISOLATED ENGINE EXECUTION (MONGO ONLY)"
echo "======================================"
echo ""
...
echo "Cleaning up old CSV results for selected profiles (Mongo only)..."
mkdir -p results/
for PROFILE in "${PROFILES[@]}"; do
    rm -f results/*mongo*_${PROFILE}.csv
done
...
echo "======================================"
printf "✅ MONGO BENCHMARKS FINISHED SUCCESSFULLY\n"
