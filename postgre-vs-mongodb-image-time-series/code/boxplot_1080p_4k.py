...
PROFILE_ORDER = ["1080p_fhd_image", "1440p_qhd_image", "4k_uhd_image"]
PROFILE_LABELS = ["1080p", "1440p", "4K"]
...
plt.title("Insert Throughput vs Image Resolution (1080p to 4K)")
plt.xlabel("Image Resolution")
plt.ylabel("Rows per Second")
plt.legend()
style_lineplot(plt.gca())
plt.tight_layout()
plt.savefig("../paper/figures/boxplot_insert_throughput_1080p_4k.pdf")
plt.close()
...
if mg_y:
    plt.errorbar(labels_mg, mg_y, yerr=mg_std, label="MongoDB", marker="s", capsize=5, lw=2.5, markersize=8)
plt.title("Binary Retrieval Latency vs Image Resolution (1080p to 4K)")
plt.xlabel("Image Resolution")
...
style_lineplot(plt.gca())
plt.tight_layout()
plt.savefig("../paper/figures/boxplot_retrieval_latency_1080p_4k.pdf")
plt.close()

print("Generated plots for 1080p to 4K!")
